...
const initHomeApp = function () {
    ...
    homeApp.component('property',{
        ...
        methods:{
            ...
            showProperty(){
                window.location.href = '/propertyviewer.html?propertyid='+ this.propertyData.id;
                ...
                <div id="finderContainerBlock" class="slider js-slider">
                    ...
                    <div id="filterContainer">
                        ...
                        <div id="filterBlock">
                            ...
                            <div id="filterDiv" v-if="isBigCanvas()">
                            ...
                            <a v-else id="mobileGetStartedButton" href="#catalogBody">GET STARTED</a>
                        </div>
                    </div>
                </div>
                <div id="catalogBody">
    ...
    homeApp.component('homeapp',{
        ...
        methods:{
            ...
            isCurrentPage(fileName){
                ...
                return currentPath.endsWith('/' + normalizedFile);
            },
        },
        template:`
            ...
            <div id="footerBlock">
                <div id="footerHead">Nivi Homes private limited</div>
            </div>
        `
    });
    return homeApp;
