...
function showHomeHintToast(){
    const homeContainer = document.getElementById('homeAppContainer');
    if(!homeContainer || document.getElementById('appHintToast')){
        return;
    }

    const toast = document.createElement('div');
    toast.setAttribute('id', 'appHintToast');
    toast.textContent = 'Tip: Click any building card to open the 3D Building app.';
